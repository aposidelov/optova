(function ($) {
	...
	function DateTimePicker(options) {
		...
		for (i = 0; i <= 23; i++) html1 = hourHTML.append("<option>" + pad.substring(0, pad.length - (""+i).length) + i + "</option");
		for (i = 0; i < 60; i = i + 1) html2 = minutsHTML.append("<option>" + pad.substring(0, pad.length - (""+i).length) + i + "</option");
		for (i = 0; i < 60; i = i + 1) html3 = secondHTML.append("<option>" + pad.substring(0, pad.length - (""+i).length) + i + "</option");
        



        /*
        html1 = "<input class='dateimepicker-hour' onchange='$.datetimepicker.isDirty = true;'/>"
        html2 = "<input class='dateimepicker-minuts' onchange='$.datetimepicker.isDirty = true;'/>" 
        html3 = "<input class='dateimepicker-second' onchange='$.datetimepicker.isDirty = true;'/>" 
        */
